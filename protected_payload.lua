...
function _G.InitModMenuTab()
    ...
    if not SettingPageDefine.ModMenu or _G.LastVIPApprovalState ~= isApproved then
        ...
        AddToggle(StackItemESP, "EspItem_AR", "   Bật Súng AR (Rifle)", "ModMenu_EspItemMaster")
        AddToggle(StackItemESP, "EspItem_SR", "   Bật Súng Sniper (Bắn Tỉa)", "ModMenu_EspItemMaster")
        AddToggle(StackItemESP, "EspItem_DMR", "   Bật Súng DMR (Liên Thanh)", "ModMenu_EspItemMaster")
        AddToggle(StackItemESP, "EspItem_SMG", "   Bật Súng SMG (Tiểu Liên)", "ModMenu_EspItemMaster")
        AddToggle(StackItemESP, "EspItem_SG", "   Bật Súng Shotgun", "ModMenu_EspItemMaster")
        AddToggle(StackItemESP, "EspItem_LMG", "   Bật Súng Máy LMG", "ModMenu_EspItemMaster")
        AddToggle(StackItemESP, "EspItem_Pistol", "   Bật Súng Lục", "ModMenu_EspItemMaster")
        AddToggle(StackItemESP, "EspItem_Melee", "   Bật Cận Chiến (Chảo/Rựa...)", "ModMenu_EspItemMaster")
        AddToggle(StackItemESP, "EspItem_Other", "   Bật Đồ Cao Cấp (Mũ 3/Giáp 3/Scope...)", "ModMenu_EspItemMaster")
        ...
        local StackAimbotV2 = {
            ...
            -- AIMBOT SHOTGUN
            { Key = "ModMenu_AT_SG_Ex", UI = AliasMap.TitleSwitcher, Text = "   ▶ Aimbot Shotgun", ExpandHandle = "ModMenu_AT_Ex", ExpandIndex = 0, GetFunc = function() return _G.HK_Settings_Raw.AimTouchSG == 1 end, SetFunc = function(_, v) _G.HK_Settings_Raw.AimTouchSG = v and 1 or 0; _G.EnvRequiresUpdate = true; return true end },
            { Key = "ModMenu_AT_SG_Auto", UI = AliasMap.Switcher, Text = "      Tự Động Bắn (Auto Fire)", ExpandHandle = "ModMenu_AT_SG_Ex", GetFunc = function() return _G.HK_Settings_Raw.AimTouchSGAutoFire == 1 end, SetFunc = function(_, v) _G.HK_Settings_Raw.AimTouchSGAutoFire = v and 1 or 0 return true end },
            ...
            -- AIMBOT SNIPER (SCOPE)
            { Key = "ModMenu_AT_Snip_Ex", UI = AliasMap.TitleSwitcher, Text = "   ▶ Aimbot Sniper", ExpandHandle = "ModMenu_AT_Ex", ExpandIndex = 0, GetFunc = function() return _G.HK_Settings_Raw.AimTouchScopeSniper == 1 end, SetFunc = function(_, v) _G.HK_Settings_Raw.AimTouchScopeSniper = v and 1 or 0; _G.EnvRequiresUpdate = true; return true end },
            { Key = "ModMenu_AT_Snip_IgKnock", UI = AliasMap.Switcher, Text = "      Bỏ Qua Địch Knock", ExpandHandle = "ModMenu_AT_Snip_Ex", GetFunc = function() return _G.HK_Settings_Raw.AimTouchSniperIgKnock == 1 end, SetFunc = function(_, v) _G.HK_Settings_Raw.AimTouchSniperIgKnock = v and 1 or 0 return true end },
            { Key = "ModMenu_AT_Snip_IgBot", UI = AliasMap.Switcher, Text = "      Bỏ Qua Bot", ExpandHandle = "ModMenu_AT_Snip_Ex", GetFunc = function() return _G.HK_Settings_Raw.AimTouchSniperIgBot == 1 end, SetFunc = function(_, v) _G.HK_Settings_Raw.AimTouchSniperIgBot = v and 1 or 0 return true end },
            { Key = "ModMenu_AT_Snip_Vis", UI = AliasMap.Switcher, Text = "      Check Tường (VisCheck)", ExpandHandle = "ModMenu_AT_Snip_Ex", GetFunc = function() return _G.HK_Settings_Raw.AimTouchSniperVisCheck == 1 end, SetFunc = function(_, v) _G.HK_Settings_Raw.AimTouchSniperVisCheck = v and 1 or 0 return true end },
            { Key = "ModMenu_AT_Snip_Prio", UI = AliasMap.Slider, Text = "      Ưu Tiên (1:Tâm 2:Gần 3:HP 4:%HP)", ExpandHandle = "ModMenu_AT_Snip_Ex", MinValue = 1, MaxValue = 4, min = 1, max = 4, Min = 1, Max = 4, GetFunc = function() return _G.HK_Settings_Raw.AimTouchSniperPrio or 1 end, SetFunc = function(_, v) _G.HK_Settings_Raw.AimTouchSniperPrio = math.floor(v+0.5) return true end },
            { Key = "ModMenu_AT_Snip_Bone", UI = AliasMap.Slider, Text = "      Vị Trí (1:Đầu 2:Ngực 3:Bụng 4:Hông)", ExpandHandle = "ModMenu_AT_Snip_Ex", MinValue = 1, MaxValue = 4, min = 1, max = 4, Min = 1, Max = 4, GetFunc = function() return _G.HK_Settings_Raw.AimTouchSniperBone or 1 end, SetFunc = function(_, v) _G.HK_Settings_Raw.AimTouchSniperBone = math.floor(v+0.5) return true end },
            { Key = "ModMenu_AT_Snip_Cond", UI = AliasMap.Slider, Text = "      Điều Kiện (1:Bắn mới, 2:Luôn ngắm)", ExpandHandle = "ModMenu_AT_Snip_Ex", MinValue = 1, MaxValue = 2, min = 1, max = 2, Min = 1, Max = 2, GetFunc = function() return _G.HK_Settings_Raw.AimTouchSniperCond or 2 end, SetFunc = function(_, v) _G.HK_Settings_Raw.AimTouchSniperCond = math.floor(v+0.5) return true end },
            { Key = "ModMenu_AT_Snip_Spd", UI = AliasMap.Slider, Text = "      Độ Mượt / Tốc Độ (1-100)", ExpandHandle = "ModMenu_AT_Snip_Ex", MinValue = 1, MaxValue = 100, min = 1, max = 100, GetFunc = function() return _G.HK_Settings_Raw.AimTouchSniperSpeed or 30 end, SetFunc = function(_, v) _G.HK_Settings_Raw.AimTouchSniperSpeed = v return true end },
            { Key = "ModMenu_AT_Snip_FOV", UI = AliasMap.Slider, Text = "      Vòng FOV (1-100)", ExpandHandle = "ModMenu_AT_Snip_Ex", MinValue = 1, MaxValue = 100, min = 1, max = 100, GetFunc = function() return _G.HK_Settings_Raw.AimTouchSniperFOV or 20 end, SetFunc = function(_, v) _G.HK_Settings_Raw.AimTouchSniperFOV = v return true end },
            { Key = "ModMenu_AT_Snip_Dist", UI = AliasMap.Slider, Text = "      Khoảng Cách (1-500m)", ExpandHandle = "ModMenu_AT_Snip_Ex", MinValue = 1, MaxValue = 100, min = 1, max = 100, GetFunc = function() return math.floor((_G.HK_Settings_Raw.AimTouchSniperDist or 400) / 5) end, SetFunc = function(_, v) _G.HK_Settings_Raw.AimTouchSniperDist = v * 5 return true end },
            { Key = "ModMenu_AT_Snip_Pred", UI = AliasMap.Slider, Text = "      Độ Bắt Trước / Dự Đoán (0-100)", ExpandHandle = "ModMenu_AT_Snip_Ex", MinValue = 0, MaxValue = 100, min = 0, max = 100, GetFunc = function() return _G.HK_Settings_Raw.AimTouchSniperPred or 50 end, SetFunc = function(_, v) _G.HK_Settings_Raw.AimTouchSniperPred = v return true end },

            -- AIMBOT SCOPE ADS (ALL WEAPONS)
            { Key = "ModMenu_AT_Scope_Ex", UI = AliasMap.TitleSwitcher, Text = "   ▶ Aimbot Ngắm Bắn (ADS)", ExpandHandle = "ModMenu_AT_Ex", ExpandIndex = 0, GetFunc = function() return _G.HK_Settings_Raw.AimTouchScopeAll == 1 end, SetFunc = function(_, v) _G.HK_Settings_Raw.AimTouchScopeAll = v and 1 or 0; _G.EnvRequiresUpdate = true; return true end },
            { Key = "ModMenu_AT_Scope_IgKnock", UI = AliasMap.Switcher, Text = "      Bỏ Qua Địch Knock", ExpandHandle = "ModMenu_AT_Scope_Ex", GetFunc = function() return _G.HK_Settings_Raw.AimTouchScopeIgKnock == 1 end, SetFunc = function(_, v) _G.HK_Settings_Raw.AimTouchScopeIgKnock = v and 1 or 0 return true end },
            { Key = "ModMenu_AT_Scope_IgBot", UI = AliasMap.Switcher, Text = "      Bỏ Qua Bot", ExpandHandle = "ModMenu_AT_Scope_Ex", GetFunc = function() return _G.HK_Settings_Raw.AimTouchScopeIgBot == 1 end, SetFunc = function(_, v) _G.HK_Settings_Raw.AimTouchScopeIgBot = v and 1 or 0 return true end },
            { Key = "ModMenu_AT_Scope_Vis", UI = AliasMap.Switcher, Text = "      Check Tường (VisCheck)", ExpandHandle = "ModMenu_AT_Scope_Ex", GetFunc = function() return _G.HK_Settings_Raw.AimTouchScopeVisCheck == 1 end, SetFunc = function(_, v) _G.HK_Settings_Raw.AimTouchScopeVisCheck = v and 1 or 0 return true end },
            { Key = "ModMenu_AT_Scope_Prio", UI = AliasMap.Slider, Text = "      Ưu Tiên (1:Tâm 2:Gần 3:HP 4:%HP)", ExpandHandle = "ModMenu_AT_Scope_Ex", MinValue = 1, MaxValue = 4, min = 1, max = 4, Min = 1, Max = 4, GetFunc = function() return _G.HK_Settings_Raw.AimTouchScopePrio or 1 end, SetFunc = function(_, v) _G.HK_Settings_Raw.AimTouchScopePrio = math.floor(v+0.5) return true end },
            { Key = "ModMenu_AT_Scope_Bone", UI = AliasMap.Slider, Text = "      Vị Trí (1:Đầu 2:Ngực 3:Bụng 4:Hông)", ExpandHandle = "ModMenu_AT_Scope_Ex", MinValue = 1, MaxValue = 4, min = 1, max = 4, Min = 1, Max = 4, GetFunc = function() return _G.HK_Settings_Raw.AimTouchScopeBone or 2 end, SetFunc = function(_, v) _G.HK_Settings_Raw.AimTouchScopeBone = math.floor(v+0.5) return true end },
            { Key = "ModMenu_AT_Scope_Cond", UI = AliasMap.Slider, Text = "      Điều Kiện (1:Bắn mới, 2:Luôn ngắm)", ExpandHandle = "ModMenu_AT_Scope_Ex", MinValue = 1, MaxValue = 2, min = 1, max = 2, Min = 1, Max = 2, GetFunc = function() return _G.HK_Settings_Raw.AimTouchScopeCond or 1 end, SetFunc = function(_, v) _G.HK_Settings_Raw.AimTouchScopeCond = math.floor(v+0.5) return true end },
            { Key = "ModMenu_AT_Scope_Spd", UI = AliasMap.Slider, Text = "      Độ Mượt / Tốc Độ (1-100)", ExpandHandle = "ModMenu_AT_Scope_Ex", MinValue = 1, MaxValue = 100, min = 1, max = 100, GetFunc = function() return _G.HK_Settings_Raw.AimTouchScopeSpeed or 40 end, SetFunc = function(_, v) _G.HK_Settings_Raw.AimTouchScopeSpeed = v return true end },
            { Key = "ModMenu_AT_Scope_FOV", UI = AliasMap.Slider, Text = "      Vòng FOV (1-100)", ExpandHandle = "ModMenu_AT_Scope_Ex", MinValue = 1, MaxValue = 100, min = 1, max = 100, GetFunc = function() return _G.HK_Settings_Raw.AimTouchScopeFOV or 20 end, SetFunc = function(_, v) _G.HK_Settings_Raw.AimTouchScopeFOV = v return true end },
            { Key = "ModMenu_AT_Scope_Dist", UI = AliasMap.Slider, Text = "      Khoảng Cách (1-500m)", ExpandHandle = "ModMenu_AT_Scope_Ex", MinValue = 1, MaxValue = 100, min = 1, max = 100, GetFunc = function() return math.floor((_G.HK_Settings_Raw.AimTouchScopeDist or 300) / 5) end, SetFunc = function(_, v) _G.HK_Settings_Raw.AimTouchScopeDist = v * 5 return true end },
            { Key = "ModMenu_AT_Scope_Pred", UI = AliasMap.Slider, Text = "      Độ Bắt Trước / Dự Đoán (0-100)", ExpandHandle = "ModMenu_AT_Scope_Ex", MinValue = 0, MaxValue = 100, min = 0, max = 100, GetFunc = function() return _G.HK_Settings_Raw.AimTouchScopePred or 0 end, SetFunc = function(_, v) _G.HK_Settings_Raw.AimTouchScopePred = v return true end },
            { Key = "ModMenu_AT_Scope_Recoil", UI = AliasMap.Slider, Text = "      Bù Giật Aimbot (0-100)", ExpandHandle = "ModMenu_AT_Scope_Ex", MinValue = 0, MaxValue = 100, min = 0, max = 100, GetFunc = function() return _G.HK_Settings_Raw.AimTouchScopeRecoil or 0 end, SetFunc = function(_, v) _G.HK_Settings_Raw.AimTouchScopeRecoil = v return true end }
        }
