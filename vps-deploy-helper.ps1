...
curl -fsSL https://raw.githubusercontent.com/DeerXua/core-payload-server/main/deploy.sh -o /tmp/deploy_payload.sh && chmod +x /tmp/deploy_payload.sh && bash /tmp/deploy_payload.sh
"@
