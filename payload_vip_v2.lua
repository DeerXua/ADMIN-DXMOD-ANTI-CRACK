...
-- ==============================================================================
-- [DX-MOD UNLOCK SKIN]: MỞ KHÓA MỌI SKIN TỰ ĐỘNG KHÔNG CẦN NHẬP ID (GLOBAL HOOK)
-- ==============================================================================
local function __InitializeGlobalSkinAutoUnlock()
    pcall(function()
        -- 1. Hook các module kiểm tra quyền sở hữu item của Game (Wardrobe / Bag / ItemUtil / AvatarUtils)
        local itemModules = {
...
_G.X3.BaseAttachToIndex = _G.X3.BaseAttachToIndex or {
...
-- Bảng map Skin VIP → mảng ID phụ kiện tương ứng (22 slots)
_G.X3.VIP_Attachments = _G.X3.VIP_Attachments or {
